  ...
  return (
    <div>
      ...
      <div className=" mt-28 mb-9  container mx-auto">
        ...
        <PopularShowRooms  items={<>
          <div  className=" mt-14 flex gap-6">
          <div className="border-4  w-[48%] border-primary  rounded-2xl overflow-hidden">
            <div className="   h-4/4">
              <img src={require('../../assets/images/image 7.png')} className=" w-full h-full object-cover object-center" alt="" />
            </div>
            <div className=" p-4">
             <h5 className=" text-secondary font-bold uppercase">Chevrolet Camaro 2-door </h5>
             <div className="  mt-3 flex justify-between items-center">
              <div  className=" flex gap-2 items-center">
                <img src={require('../../assets/images/can.png')} className=" w-4" alt="" />
                <span className=" text-textColor font-bold">2021</span>
              </div>
              <div className="flex gap-2 items-center">
                <img src={require('../../assets/images/cal.png')} className=" w-6" alt="" />
                <span className=" text-textColor font-bold">4 Cylinder</span>
              </div>
              <div  className="flex gap-2 items-center">
                <img src={require('../../assets/images/road.png')} className=" w-4" alt="" />
                <span className=" text-textColor font-bold">44, 882 KM</span>
              </div>
             </div>

             <div className=" flex justify-between items-center mt-3">
             <h5 className=" text-green text-sm font-bold ">QR. 15,233 / Month </h5>
             <h5 className=" text-secondary font-bold uppercase">qr. 433,000 </h5>
             </div>
            </div>
          </div>
