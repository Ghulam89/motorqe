...
import { FaCalendarAlt, FaCircle, FaFlag, FaHeart, FaMobileAlt, FaRegEnvelope, FaShareAlt, FaWhatsapp } from 'react-icons/fa'
        ...
        <div className=' md:flex block   justify-between '>
          ...
          <div className=' py-10'>
             <ul className='  w-[69%]   mx-auto flex items-center border  rounded-3xl overflow-hidden'>
                ...
                <li>
                  <Button  label={'Inspection Report'} className={'  text-textColor  font-semibold bg-gray-50  py-3.5 border-r'}  />
                </li>
                <li>
                  <Button  label={'Spare Parts'} className={'  text-textColor  font-semibold bg-gray-50  py-3.5 border-r'}  />
                </li>
                <li>
                  <Button  label={'Tyres'} className={'  text-textColor  font-semibold bg-gray-50  py-3.5 border-r'}  />
                </li>
             </ul>
          </div>
          ...
          <div>
           ...
           <Link to={''} className=' decoration-black text-secondary font-semibold border-b-2  border-secondary'>See more</Link>
           </button>
          </div>
          <div className='bg-[#F2F8FF] my-4 p-5 py-10'>
            ...
            <ul className=' flex flex-wrap items-center gap-5'>
                <li>
                    <button className=' flex items-center gap-3 bg-white py-2 px-4 border rounded-md'> <FaRegCircleCheck  color='' className=' text-primary' /><span className=' font-semibold'> Backup camera</span></button>
                </li>
                <li>
                    <button className=' flex items-center gap-3 bg-white py-2 px-4 border rounded-md'> <FaRegCircleCheck  color='' className=' text-primary' /><span className=' font-semibold'> Blind-spot warning</span></button>
                </li>
                <li>
                    <button className=' flex items-center gap-3 bg-white py-2 px-4 border rounded-md'> <FaRegCircleCheck  color='' className=' text-primary' /><span className=' font-semibold'> Brake assist</span></button>
                </li>
                <li>
                    <button className=' flex items-center gap-3 bg-white py-2 px-4 border rounded-md'> <FaRegCircleCheck  color='' className=' text-primary' /><span className=' font-semibold'>Forward-collision warning</span></button>
                </li>
                <li>
                    <button className=' flex items-center gap-3 bg-white py-2 px-4 border rounded-md'> <FaRegCircleCheck  color='' className=' text-primary' /><span className=' font-semibold'>Forward-collision warning</span></button>
                </li>
            ...
            <div className=' md:px-0 px-5'>
              ...
              <ul className=' flex flex-col gap-4'>
                ...
                <li className=' flex justify-between items-center'>
                    ...
                    <span className=' text-textColor font-bold text-xl'>Bmw</span>
                </li>
                <li className=' flex justify-between items-center'>
                    <h4 className='h5'>Model:</h4>
                    <span className=' text-textColor font-bold text-xl'>M8</span>
                </li>
                <li className=' flex justify-between items-center'>
                    <h4 className='h5'>Year:</h4>
                    <span className=' text-textColor font-bold text-xl'>2021</span>
                </li>
                <li className=' flex justify-between items-center'>
                ...
                <li className=' flex justify-between items-center'>
                    ...
                    <span className=' text-textColor font-bold text-xl'>23,500Kms</span>
                </li>
                <li className=' flex justify-between items-center'>
                ...
                <li className=' flex justify-between items-center'>
                    ...
                    <span className=' text-textColor font-bold text-xl'>Green</span>
                </li>
                <li className=' flex justify-between items-center'>
                    <h4 className='h5'>Interior Colour:</h4>
                    <span className=' text-textColor font-bold text-xl'>Tan</span>
                </li>
                <li className=' flex justify-between items-center'>
              ...
              />
                ...
                <div className=' py-4'>
                    <h5 className=' text-textColor font-medium'> <b>Street:</b> Salwa Road </h5>
                    <h5 className=' text-textColor font-medium'> <b>City:</b> Doha </h5>
                </div>
       ...
       <div className=' md:flex block py-6'>
        <div className=' md:w-[45%] w-[100%]'>
          ...
          <ul className=' flex  gap-8 flex-wrap'>
            ...
            <li className=' flex items-center gap-2'>
            <FaCircle size={9} className=' text-primary' />
            <span className=' text-black font-semibold'>Navigation System</span>
            </li>
            <li className=' flex items-center gap-2'>
            <FaCircle size={9} className=' text-primary' />
        ...
        <div className=' flex items-center gap-5 mt-2'>
          <div className=' flex gap-3 items-center '>
            <img src={require('../../assets/images/pdf.png')} className=' w-10'  alt='' />
            <span className=' text-black'>Sample PDF File</span>
          </div>
          <div className=' flex gap-3 items-center '>
            <img src={require('../../assets/images/pdf.png')} className=' w-10'  alt='' />
            <span className=' text-black'>Notes and some related files</span>
          </div>
        </div>
        </div>
       </div>
        ...
        <h1 className=' text-secondary font-bold text-3xl py-4'>QR 62,000</h1>
          <Button label={'Apply Now'} className={' bg-primary  mx-auto mt-5 rounded-3xl py-2 text-white font-semibold'}  />
        ...
        <div className=' mt-4 flex flex-wrap gap-6'>
          <div className='  rounded-xl overflow-hidden'>
            ...
            <div className=' h-40 relative'>
              <img src={require('../../assets/images/image 7.png')} className=' object-cover  h-full w-full' alt='' />
            ...
            <div className=' bg-[#0C53AB] py-2 px-4'>
              <h1 className=' text-white uppercase font-semibold'>Audi A8 4-door sedan blue</h1>
              <div className="  mt-3 flex justify-between items-center">
                ...
                <div className="flex gap-2 items-center">
                  <img
                    ...
                    alt=""
                  />
                  <span className=" text-white text-xs font-bold">4 Cylinder</span>
                </div>
                <div className="flex gap-2 items-center">
                  <img
                    ...
                    alt=""
                  />
                  <span className=" text-white text-xs font-bold">44, 882 KM</span>
                </div>
              </div>
            </div>
